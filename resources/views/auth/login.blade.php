                ...
                <div class="glassmorphism card-signin my-5">
                    <div class="card-body">
                        ...
                        <!-- <form onsubmit="return disableButton()" class="form-signin" action="/postLogin" method="POST">
                            ...
                            <hr class="my-4">
                            <p class="text-center">Don't have any account? <a href="/register">register</a></p>
                        </form> -->
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <!-- Email Address -->
                                    <div class="form-label-group">
                                        <x-text-input class="form-control @error('email') is-invalid @enderror"  id="email" name="email" type="email" :value="old('email')" 
